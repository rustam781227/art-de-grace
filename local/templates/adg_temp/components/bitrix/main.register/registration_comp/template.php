...
<div class="bx-auth-reg">
    ...
    <? if ($arResult["SHOW_SMS_FIELD"] == true): ?>
        ...
        <form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="regform">
            ...
            <input size="30" type="text" name="SMS_CODE" value="<?= htmlspecialcharsbx($arResult["SMS_CODE"]) ?>"
                   autocomplete="off"/>
        ...
        <form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="regform" enctype="multipart/form-data">
            ...
            if ($arResult["USE_CAPTCHA"] == "Y") {
                ...
                <div class="captcha">
                    ...
                    <img src="/bitrix/tools/captcha.php?captcha_sid=<?= $arResult["CAPTCHA_CODE"] ?>" width="206"
                         height="auto" alt="CAPTCHA"/><br>
            ...
            /* !CAPTCHA */
            ?>
            <input type="submit" name="register_submit_button" value="Подтвердить"/>
